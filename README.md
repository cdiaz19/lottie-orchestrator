...
**`v3.4.0`** — public plugin API; the V3 roadmap is complete. Full history in [`CHANGELOG.md`](CHANGELOG.md).
...
| `v3.4.0` | E7 — Plugin SDK | public extension API; subscribers only, explicit import paths, no auto-discovery | ✅ |
